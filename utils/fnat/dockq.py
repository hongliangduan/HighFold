...
def main():
    ...
    # model = 'D:/Program/python/PepConform/data/output/CAMP_train/20230302185514/temp/1CQG_1_esmfold_linker_removed.pdb'
    # native = 'D:/Program/python/PepConform/data/input/CAMP_train/1CQG_1.pdb'
